...
<table align="center" width="500" border="1" cellspacing="0" cellpadding="5">
	...
	<tr>
		<th>작성자</th><td>${ notice.noticewriter}</td>
	</tr>
	<tr>
		...
		<td>
			...
			<c:if test="${ !empty notice.original_filepath }">
				<c:url var="nfd" value="/nfdown.do">
					<c:param name="ofile" value="${ notice.original_filepath }"/>	<%--컨트롤러로 전송 name 으로--%>
	...
	<tr>
		<th colspan="2"><button onclick="javascrpt:history.go(-1);">목록</button></th>
	</tr>
</table>
<hr>
